...
MERGE (n:Account {fspiAgentAccountId: "ULSBIE2D-437570486"})
ON CREATE SET n = {
...
MERGE (n:Account {fspiAgentAccountId: "ULSBIE2D-427570486"})
ON CREATE SET n = {
...
MERGE (n:Account {fspiAgentAccountId: "ULSBIE2D-427570487"})
ON CREATE SET n = {
...
MERGE (n:Account {fspiAgentAccountId: "ULSBIE2D-427570488"})
ON CREATE SET n = {
...
MERGE (n:Account {fspiAgentAccountId: "ULSBIE2D-427570489"})
ON CREATE SET n = {
...
// Bank 2
MERGE (n:Account {fspiAgentAccountId: "IPTSIEDD-427570488"})
ON CREATE SET n = {
...
MERGE (n:Account {fspiAgentAccountId: "IPTSIEDD-527570498"})
ON CREATE SET n = {
...
MERGE (n:Account {fspiAgentAccountId: "IPTSIEDD-724570489"})
ON CREATE SET n = {
