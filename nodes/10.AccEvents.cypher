...
ON CREATE SET
  ...
  n.eventTime = "20/07/2025 14:02:10.234",
  n.baseValue = 2342.00,
  n.currency = "EUR",
...
ON CREATE SET
    ...
    n.eventTime = "20/07/2025 14:03:10",
...
ON CREATE SET
    ...
    n.eventTime = "23/07/2025 15:43:10",
    n.baseValue = 2998.00,
    n.currency = "EUR",
    n.direction = "outbound",
    n.paymentSystem = "10",
...
ON CREATE SET
    ...
    n.eventTime = "24/07/2025 11:43:10",
    n.baseValue = 2907.00,
    n.currency = "EUR",
    n.direction = "outbound",
    n.paymentSystem = "RTPUSHPAY",
...
ON CREATE SET
    ...
    n.eventTime = "24/07/2025 15:43:10",
    n.baseValue = 5907.00,
    n.currency = "EUR",
    n.direction = "outbound",
    n.paymentSystem = "10",
...
ON CREATE SET
    ...
    n.eventTime = "21/07/2025 11:13:10",
...
ON CREATE SET
    ...
    n.eventTime = "21/07/2025 15:13:10",
...
ON CREATE SET
    ...
    n.eventTime = "22/07/2025 11:13:10",
    n.baseValue = 4907.00,
    n.currency = "EUR",
    n.direction = "outbound",
    n.paymentSystem = "10",
...
ON CREATE SET
    ...
    n.eventTime = "24/07/2025 09:13:10",
